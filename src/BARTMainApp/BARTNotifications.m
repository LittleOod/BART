...
NSString * const BARTStepConfigurationNotification = @"BARTStepConfigurationNotification";
NSString * const BARTStepConfigurationNotificationEventTypeKey = @"BARTStepConfigurationNotificationEventTypeKey";
